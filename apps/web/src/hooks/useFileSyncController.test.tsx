...
import type { GameVersion, SaveData } from '@dexhelper/engine/saveParser/index';
import * as saveParser from '@dexhelper/engine/saveParser/index';
...
vi.mock('@dexhelper/engine/saveParser/index', () => ({
