import type { CallerType } from '@dexhelper/engine/saveParser/parsers/gen2/phone/constants';
import type { Contact } from '@dexhelper/engine/saveParser/parsers/gen2/phone/predictor';
