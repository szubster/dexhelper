...
import { FRONTIER_BRAIN_THRESHOLDS } from '@dexhelper/engine/gen3/battleFrontier/constants';
import type { Gen3BattleFrontierWinStreaks, SaveData } from '@dexhelper/engine/saveParser/parsers/common';
