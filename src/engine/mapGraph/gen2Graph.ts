...
export const gen2MapGraph: Record<number, MapGraphNode> = {
  ...
  0x0306: { name: 'Goldenrod City', connections: [0x0a04, 0x0b01, 0x1902] }, // Rd 34, Rd 35
  ...
  0x0307: { name: 'Olivine City', connections: [0x010a, 0x1601, 0x0c03] }, // Rd 39, Rd 40
  ...
  0x1801: { name: 'Route 26', connections: [0x1802, 0x1702] }, // Route 27 (connects to Kanto Reception Gate)
  0x1301: { name: 'Route 28', connections: [0x1801, 0x034a] }, // Route 26, Silver Cave
  0x034a: { name: 'Silver Cave', connections: [0x1301] }, // Route 28
  // Kanto Hubs (for Gen 2 cross-region distance)
  0x1902: { name: 'Saffron City', connections: [0x0306] },
  0x0c03: { name: 'Vermilion City', connections: [0x0307] },
  0x1702: { name: 'Route 22', connections: [0x1801] },
};
