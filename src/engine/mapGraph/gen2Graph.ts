...
export const gen2MapGraph: Record<number, MapGraphNode> = {
  ...
  0x0306: { name: 'Goldenrod City', connections: [0x0a04, 0x0b01, 0x0a] }, // Rd 34, Rd 35, Saffron (Magnet Train)
  ...
  0x0307: { name: 'Olivine City', connections: [0x010a, 0x1601, 0x05] }, // Rd 39, Rd 40, Vermilion (S.S. Aqua)
