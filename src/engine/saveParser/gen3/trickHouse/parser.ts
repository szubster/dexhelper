...
export const VARS_START_ID = 0x4000;
export const BYTES_PER_VAR = 2;
export const BITS_PER_BYTE = 8;

export const VAR_TRICK_HOUSE_LEVEL_OFFSET = SAVE_BLOCK_1_VARS_OFFSET + (0x4044 - VARS_START_ID) * BYTES_PER_VAR;
export const VAR_TRICK_HOUSE_ENTRANCE_STATE_OFFSET =
  SAVE_BLOCK_1_VARS_OFFSET + (0x40a7 - VARS_START_ID) * BYTES_PER_VAR;
export const VAR_TRICK_HOUSE_ENTER_FROM_CORRIDOR_OFFSET =
  SAVE_BLOCK_1_VARS_OFFSET + (0x40b5 - VARS_START_ID) * BYTES_PER_VAR;
export const VAR_TRICK_HOUSE_PRIZE_PICKUP_OFFSET = SAVE_BLOCK_1_VARS_OFFSET + (0x40c1 - VARS_START_ID) * BYTES_PER_VAR;

export const VAR_TRICK_HOUSE_PUZZLE_1_STATE_OFFSET =
  SAVE_BLOCK_1_VARS_OFFSET + (0x40ab - VARS_START_ID) * BYTES_PER_VAR;
export const VAR_TRICK_HOUSE_PUZZLE_2_STATE_OFFSET =
  SAVE_BLOCK_1_VARS_OFFSET + (0x40ac - VARS_START_ID) * BYTES_PER_VAR;
export const VAR_TRICK_HOUSE_PUZZLE_3_STATE_OFFSET =
  SAVE_BLOCK_1_VARS_OFFSET + (0x40ad - VARS_START_ID) * BYTES_PER_VAR;
export const VAR_TRICK_HOUSE_PUZZLE_4_STATE_OFFSET =
  SAVE_BLOCK_1_VARS_OFFSET + (0x40ae - VARS_START_ID) * BYTES_PER_VAR;
export const VAR_TRICK_HOUSE_PUZZLE_5_STATE_OFFSET =
  SAVE_BLOCK_1_VARS_OFFSET + (0x40af - VARS_START_ID) * BYTES_PER_VAR;
export const VAR_TRICK_HOUSE_PUZZLE_6_STATE_OFFSET =
  SAVE_BLOCK_1_VARS_OFFSET + (0x40b0 - VARS_START_ID) * BYTES_PER_VAR;
export const VAR_TRICK_HOUSE_PUZZLE_7_STATE_OFFSET =
  SAVE_BLOCK_1_VARS_OFFSET + (0x40b1 - VARS_START_ID) * BYTES_PER_VAR;
export const VAR_TRICK_HOUSE_PUZZLE_8_STATE_OFFSET =
  SAVE_BLOCK_1_VARS_OFFSET + (0x40b2 - VARS_START_ID) * BYTES_PER_VAR;

export const FLAG_LANDMARK_TRICK_HOUSE = 0x8a2;
export const FLAG_LANDMARK_TRICK_HOUSE_BYTE_OFFSET =
  SAVE_BLOCK_1_FLAGS_OFFSET + Math.floor(FLAG_LANDMARK_TRICK_HOUSE / BITS_PER_BYTE);
export const FLAG_LANDMARK_TRICK_HOUSE_BIT = FLAG_LANDMARK_TRICK_HOUSE % BITS_PER_BYTE;
