import type { StaticGift } from '../../data/gen1/assistantData';
...
import type { AssistantApiData, Suggestion } from '../strategies/types';
 ...
 */
export function checkFlag(flags: Uint8Array | undefined, flagId: number | undefined) {
 ...
 * @param staticGiftEntries - The pre-computed array of static gift entries from suggestionEngine.
 */
export function generateGiftAndTradeSuggestions(
  ...
  staticGiftEntries: { giftId: number; gift: StaticGift }[],
) {
