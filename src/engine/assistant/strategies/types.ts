...
/**
 * Categories categorizing the type of action a player needs to take to obtain a Pokemon.
 */
export type SuggestionCategory = 'Catch' | 'Evolve' | 'Breed' | 'Progress' | 'Event' | 'Utility' | 'Trade' | 'Gift';

/**
 * Details an encounter's parameters like chance, method, level and location.
 */
...
/**
 * Common properties for all suggestions generated by the engine.
 */
...
/**
 * Specific suggestion subtype for Wild Encounters.
 */
...
/**
 * Specific suggestion subtype for Non-Wild Encounters like Gifts, Trades, Evolutions, Breeding, etc.
 */
...
/**
 * A union type for all suggestion types.
 */
export type Suggestion = CatchSuggestion | StandardSuggestion;

/**
 * Information detailing why a Pokemon suggestion was rejected and not displayed.
 */
