...
import type { AssistantApiData } from '../engine/assistant/strategies/types';
...
vi.mock('../engine/assistant/suggestionEngine', async (importOriginal) => {
  const actual = await importOriginal<typeof import('../engine/assistant/suggestionEngine')>();
  return {
    ...actual,
...
import { fetchAssistantApiData } from '../engine/assistant/suggestionEngine';
