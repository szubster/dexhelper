        ...
        return (
          ...
          >
            ...
            {pokemonInLocation.length === 0 ? (
              <div className="py-12 flex flex-col items-center justify-center border-2 border-dashed border-zinc-900 rounded-3xl bg-zinc-950/50 group hover:border-zinc-800 transition-colors">
                <div className="text-[10px] font-black text-zinc-700 uppercase tracking-[0.2em] group-hover:text-zinc-500 transition-colors">
                  EMPTY
                </div>
              </div>
            ) : (
