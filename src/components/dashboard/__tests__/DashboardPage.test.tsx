...
describe('DashboardPage', () => {
  beforeEach(() => {
    queryClient.clear();
    useEmulatorStore.setState({ saveData: null });
  ...
  it('renders checklist for gen 1', async () => {
    const saveData = { generation: 1 } as SaveData;
    useEmulatorStore.setState({ saveData });
    useStore.setState({ saveData });
  ...
  it('renders Gen 3 dashboard', async () => {
    const saveData = { generation: 3, gameVersion: 'emerald', partyDetails: [], pcDetails: [] } as unknown as SaveData;
    useEmulatorStore.setState({ saveData });
    useStore.setState({ saveData });
