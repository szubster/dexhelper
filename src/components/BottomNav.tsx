...
import { Database, GitGraph, LayoutGrid, Settings2, ShieldAlert, Sparkles } from 'lucide-react';
...
export function BottomNav() {
  ...
  const activeIndex = isDex ? 0 : isStorage ? 1 : isAssistant ? 2 : isRun ? 3 : isDag ? 4 : -1;
