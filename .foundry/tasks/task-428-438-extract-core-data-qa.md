...
## Acceptance Criteria
- [x] Application builds successfully and `pokedata-core.msgpack` is present in the output.
- [x] Application loads without errors and core IndexedDB stores (pokemon, moves, items) are populated correctly.
- [x] E2E tests pass and correctly verify the new data loading behavior.
