---
id: task-269-270-e2e-safeguard-qa
type: TASK
...
jules_session_id: '398398588047892810'
pr_number: null
...
## Context
As part of enforcing macro node functional boundaries, we need to ensure that an EPIC cannot be marked `COMPLETED` until its functional requirements are verifiably integrated and tested. The implementation task (`task-269-269-e2e-safeguard-impl`) added this logic to `.github/scripts/foundry-orchestrator.ts` and `.github/scripts/foundry-heartbeat.ts`.
