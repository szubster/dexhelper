...
# Implement Playwright E2E Tests for Pokéblock Optimizer

## 1. Context & Problem Statement
With the fixtures available, we need to verify the full user flow of the Pokéblock Recipe Optimizer from the UI down to the core logic.

## 2. Solution Overview
Implement Playwright tests in the `tests/e2e/` directory. The tests should cover:
- Loading the save file using the test fixture.
