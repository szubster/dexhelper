...
## Acceptance Criteria
- [x] Write tests or perform manual QA verification to confirm active swarm data (species, location, remaining days) is parsed correctly.
- [x] Verify that `RangeError` exceptions thrown by out-of-bounds `DataView` access are gracefully caught and handled.
