...
jules_session_id: '6362674438648319175'
pr_number: null
...
## Acceptance Criteria
- [x] Verify the badge visually distinguishes Shiny Carriers from actual Shiny Pokémon.
- [x] Verify the badge correctly displays in the PC Box view.
- [x] Verify the badge correctly displays in the Pokémon Detailed view.
- [x] Verify the badge adheres to the tactical hardware aesthetic (ADR 008): `rounded-none`, `border-dashed`, monospaced fonts, no rounded corners.
