...
## Acceptance Criteria
- [ ] Add `priority: 0 # Optional. Integer representing priority.` to the YAML frontmatter block in `.foundry/docs/schema.md`.
- [ ] Document `priority` in the 3.1 Field Reference table as type `integer`, optional, and describe its purpose.
- [ ] Add the field to the 8. New Node Template block.
- [ ] Self-verification: run `pnpm lint` to verify that markdown is correct.