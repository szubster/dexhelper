...
## Acceptance Criteria
- [x] Implement logic to generate timestamped or session-unique markdown files for journals.
- [x] Ensure files are saved in the correct persona-specific directory under `.foundry/journals/`.
- [x] Update `.github/scripts` logic (e.g. `analyze-diff.js`, `foundry-orchestrator.ts`) to account for persona-specific subdirectories and timestamped files.
- [x] Implement unit tests to verify proper path generation and resolution for journals.
