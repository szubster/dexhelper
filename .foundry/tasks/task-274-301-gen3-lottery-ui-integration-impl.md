...
depends_on: []
jules_session_id: '9768635609213544424'
pr_number: null
...
## Acceptance Criteria
- [x] Selector or context hook is created to expose lottery state.
- [x] Exposed state includes Winning Number, Best Match Pokémon, OT ID, Matched Digits, and Prize Tier.
