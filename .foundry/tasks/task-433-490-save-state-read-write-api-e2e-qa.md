...
## Acceptance Criteria
- [x] Run the E2E tests and ensure they pass successfully against IndexedDB.
- [x] Ensure the tests properly verify writing save states, reading the most recent state, and reading a previous state.
