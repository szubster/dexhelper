...
depends_on: []
jules_session_id: '8969558129894227030'
locks: []
pr_number: null
parent: null
tags:
...
- **Previous Commit SHA:** `ee3b870c4cb8a7e415a12b76986046b2175b2c5c`
...
If a changelog entry or `README.md` update is warranted, create a PR adding a concise bullet point under `## [Unreleased]` or new release header `## [0.6.0] - 2026-03-15` in `CHANGELOG-dexhelper.md` with diff link comparing previous release commit SHA to new release commit SHA (e.g. [`0.5.0...0.6.0`](https://github.com/${repo}/compare/ee3b870...ad5c67a)), and update `README.md` if necessary.
