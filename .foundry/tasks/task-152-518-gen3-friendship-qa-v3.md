...
## Acceptance Criteria
- [x] Verify DataView is used exclusively for memory reads and correctly catches RangeErrors
- [x] Verify the coder relied on canonical GAEM format and offset 0x04 instead of PV % 24
