...
parent: ./stories/story-004-id-schema-decision
---
...
## Acceptance Criteria
- [x] Create a new Architectural Decision Record (ADR) file, e.g., `./docs/adrs/002-collision-free-id-schema.md`.
...
- [x] Update `./docs/schema.md` with the newly decided ID pattern. Update any examples (such as the node template) to correctly show the new structure.
