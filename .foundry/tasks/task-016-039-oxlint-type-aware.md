...
depends_on: []
jules_session_id: "785627145983366110"
...
## Instructions
- [x] 1. Update `package.json` linting scripts to run `oxlint` with `--type-aware` and `--type-check` flags.
- [x] 2. Resolve any new lint errors reported across the codebase due to the new checks.
- [x] 3. Ensure CI still passes with these expensive checks.
