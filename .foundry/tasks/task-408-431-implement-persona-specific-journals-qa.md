...
jules_session_id: '16613944879160901015'
pr_number: null
...
## Acceptance Criteria
- [x] Verify that new journals are generated as timestamped or session-unique files under `.foundry/journals/<persona>/`.
- [x] Verify that `.github/scripts` correctly resolve or ignore journals under persona-specific directories.
- [x] Ensure all unit tests introduced by the `coder` pass successfully.
- [x] Perform a manual check to ensure journals are created according to the new specifications.
