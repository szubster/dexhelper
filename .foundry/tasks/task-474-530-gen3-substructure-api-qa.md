...
## Acceptance Criteria
- [x] Review the implementation for correct offset logic (`PV % 24`) and memory safety.
- [x] Verify that no magic numbers are used and module-level constants are properly utilized.
- [x] Ensure that `RangeError` is appropriately caught and handled as per Section 13 of the schema.
- [x] Confirm all tests pass (`pnpm test`) and provide adequate coverage for the 24 permutations.
