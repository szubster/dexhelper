...
parent: "./stories/story-008-schema-examples
---

# Update Documentation Examples for Atomic Files

## Context
The examples throughout `./docs/schema.md` must accurately reflect the new atomic file structure and naming conventions, specifically showcasing single-persona ownership rather than multiple personas.
...
1. Search for examples in `./docs/schema.md` that list multiple roles in `owner_persona` or imply shared ownership.
