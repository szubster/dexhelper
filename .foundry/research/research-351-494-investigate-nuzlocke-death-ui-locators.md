...
## Acceptance Criteria
- [ ] Determine the correct CSS selectors or Playwright locators for the storage grid.
- [ ] Provide code examples of asserting the isDead visual state.
- [ ] Document the findings in the research markdown body.
