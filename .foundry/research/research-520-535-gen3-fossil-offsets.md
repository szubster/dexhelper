...
# Gen 3 Fossil Revival Offset Discovery

## Objective
Determine the exact memory locations (variables/flags) used by Generation 3 games (RSE and FRLG) to track the drop-off and pickup statuses of fossils.

## Scope
- RSE (Devon Corporation): Root Fossil (Lileep), Claw Fossil (Anorith).
