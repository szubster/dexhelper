---
id: task-121-305-gen3-tv-block-parser-retry5-qa
type: TASK
...
## Description
This task requires you to verify the implementation of the Gen 3 TV Block DataView parser performed in `task-121-304-gen3-tv-block-parser-retry5-impl`.
...
Specifically, check for the presence and usage of:
