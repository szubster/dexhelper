...
depends_on:
  - .foundry/archive/tasks/task-015-028-implement-link-checker.md
jules_session_id: null
parent: .foundry/archive/stories/story-006-015-implement-link-checker.md
...
## Context
This QA task ensures the requirements outlined in `.foundry/archive/stories/story-006-015-implement-link-checker.md` and implemented in `.foundry/archive/tasks/task-015-028-implement-link-checker.md` are met.
