...
parent: .foundry/archive/stories/story-010-persona-permissions-matrix.md
tags:
  - foundry-v2
  - architecture
  - orchestration
...
## Context
As refined in the story `.foundry/archive/stories/story-010-persona-permissions-matrix.md`, the system should guide personas rather than block them. The most effective way to do this is by updating their base prompt instructions.
