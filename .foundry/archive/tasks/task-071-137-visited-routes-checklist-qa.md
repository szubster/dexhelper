...
**Update:** This task is CANCELLED and replaced by `.foundry/archive/tasks/task-071-141-visited-routes-checklist-retry-qa.md` due to the permanent failure of its implementation dependency.
