---
id: task-071-141-visited-routes-checklist-retry-qa
type: TASK
title: QA Visited Routes Checklist Retry
status: CANCELLED
owner_persona: qa
...
# TASK: QA Visited Routes Checklist Retry
...
**Update:** This task is CANCELLED and replaced by `.foundry/archive/tasks/task-071-145-visited-routes-checklist-retry-v2-qa.md` due to the permanent failure of its implementation dependency.
