...
**Target Node:** ./prds/prd-005-010-late-binding-orchestrator.md
...
- `./epics/epic-010-persona-permissions.md`
- `./epics/epic-011-wait-and-wake-protocol.md`
- `./epics/epic-012-gastown-orchestrator.md`
