...
depends_on:
  - .foundry/archive/stories/story-004-generic-scheduling-workflow.md
jules_session_id: null
parent: .foundry/archive/epics/epic-004-generic-agent-scheduling.md
---
...
## Generated Tasks
- [ ] .foundry/archive/tasks/task-018-scheduled-agent-empty-state.md
- [ ] .foundry/archive/tasks/task-020-auto-close-empty-prs.md
