...
parent: .foundry/archive/epics/epic-006-id-pre-commit-hooks.md
---
...
### Child Nodes
- `.foundry/archive/tasks/task-022-039-implement-id-validation-hook.md`
- `.foundry/archive/tasks/task-022-040-qa-id-validation-hook.md`
