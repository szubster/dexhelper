...
- [x] .foundry/archive/tasks/task-095-157-gen3-berry-dataview-parsing.md // Tech Lead: Verified failure of initial implementation.
- [x] .foundry/archive/tasks/task-095-158-gen3-berry-dataview-parsing-qa.md // Tech Lead: Reverted incorrect frontmatter modification.
- [x] .foundry/archive/research/research-095-175-gen3-berry-implicit-data.md
- [x] .foundry/archive/tasks/task-095-183-gen3-berry-dataview-parsing-retry.md
- [x] .foundry/archive/tasks/task-095-184-gen3-berry-dataview-parsing-retry-qa.md
