...
## Generated Stories
- `.foundry/archive/stories/story-004-id-schema-decision.md`: Decision and documentation update for the new collision-free ID pattern.
- `.foundry/archive/stories/story-005-id-schema-templates.md`: Updates to templates and node generation scripts to automatically output the new ID format.
