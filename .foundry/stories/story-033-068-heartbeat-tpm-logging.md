...
depends_on:
  - ./stories/story-033-067-heartbeat-state-transitions
...
## Acceptance Criteria
- [x] Appropriate logs are written to `./journals/tpm.md` whenever a PR-less session results in a state transition.

## Downstream Nodes
- TASK: `./tasks/task-068-117-implement-heartbeat-tpm-logging.md`
