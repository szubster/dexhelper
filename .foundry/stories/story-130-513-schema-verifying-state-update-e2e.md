...
## Acceptance Criteria
- [x] Ensure that Invariant 7 in `schema.md` accurately reflects that `VERIFYING` and `COMPLETED` nodes are read-only for implementing personas.
- [x] Ensure that there are no conflicting states in the documentation regarding VERIFYING state.
- [x] task-513-549-schema-verifying-positive-checks-impl
- [x] task-513-550-schema-verifying-negative-checks-impl
- [x] task-513-551-schema-verifying-tests-impl
- [x] task-513-552-schema-verifying-e2e-qa
