...
depends_on:
  - ./stories/story-033-066-heartbeat-prless-detection
...
## Downstream Nodes
- TASK: `./tasks/task-067-114-implement-heartbeat-state-transitions.md`
- TASK: `./tasks/task-067-115-implement-heartbeat-state-transitions.md`
- TASK: `./tasks/task-067-116-qa-heartbeat-state-transitions.md`
