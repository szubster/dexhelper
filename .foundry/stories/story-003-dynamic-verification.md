...
depends_on:
  - ./docs/adrs/001-the-foundry-architecture
  - ./stories/story-002-personas
...
## Generated Tasks
- `./tasks/task-014-scaffold-architect.md`
- `./tasks/task-015-update-tech-lead-protocol.md`
- `./tasks/task-016-update-agile-coach-evolution.md`
