...
depends_on:
  - .foundry/docs/adrs/001-the-foundry-architecture
  - story-002-personas
...
- Next set of `TASK` nodes for Story 003 generated by `tech_lead`. (DONE)

## Generated Tasks
- `.foundry/tasks/task-014-scaffold-architect.md`
- `.foundry/tasks/task-015-update-tech-lead-protocol.md`
- `.foundry/tasks/task-016-update-agile-coach-evolution.md`
