...
## Acceptance Criteria
- [x] Implement parsing function that reads the 8-byte structure for each of the 40 Pokéblocks.
- [x] Map the byte fields correctly to their respective flavors and feel.
- [x] Write unit tests verifying parsing correctness against known good save blocks.
- [x] Break down into Tasks.

- [x] task-478-515-impl-pokeblock-parser
- [x] task-478-516-test-pokeblock-parser
- [x] task-478-517-qa-pokeblock-parser
