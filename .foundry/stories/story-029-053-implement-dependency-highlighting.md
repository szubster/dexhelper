...
depends_on:
  - ./stories/story-029-052-implement-graph-filtering
...
## Tasks
- `./tasks/task-053-092-implement-dependency-highlighting.md`
- `./tasks/task-053-093-qa-dependency-highlighting.md`

- `./research/research-053-002-dependency-highlighting-failure.md`
- `./tasks/task-053-124-retry-dependency-highlighting.md`
- `./tasks/task-053-125-qa-retry-dependency-highlighting.md`
