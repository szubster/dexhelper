...
parent: "./epics/epic-010-human-schema
tags:
  - human-in-the-loop
  - schema
---
...
- [x] Update the `owner_persona` enum in `./docs/schema.md` to include `human`.
- [x] Define a new optional global frontmatter field `pr_number` in `./docs/schema.md`. It should be described as an integer or null, defaulting to null.
...
## Generated Tasks
- [./tasks/task-012-024-update-human-schema.md](./tasks/task-012-024-update-human-schema.md)
