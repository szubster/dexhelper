...
## Acceptance Criteria
- [x] Algorithm correctly identifies valid breeding pairs based on Egg Groups and genders.
- [x] Algorithm accurately identifies and highlights optimal pairs involving Shiny Carriers.
...
- [x] task-084-212-breeding-pair-algorithm-impl
- [x] task-084-213-breeding-pair-algorithm-qa
- [x] research-084-242-gen2-breeding-dvs
- [x] task-084-243-breeding-pair-algorithm-impl
- [x] task-084-244-breeding-pair-algorithm-qa
