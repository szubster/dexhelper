...
depends_on:
  - ./stories/story-004-id-schema-decision
...
## Generated Tasks
- `./tasks/task-005-024-update-id-templates.md`
- `./tasks/task-005-025-update-orchestrator-validation.md`
- `./tasks/task-005-026-qa-orchestrator-validation.md`
