...
depends_on: []
jules_session_id: '1805688301608866156'
...
## Acceptance Criteria
- [ ] Create `.foundry/journals/curator/` directory with a `.gitkeep` or initial markdown
- [ ] Create `.github/agents/curator.md` with base instructions
