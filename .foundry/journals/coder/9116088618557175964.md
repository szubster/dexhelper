...
## Why
This solves the UI requirement where the user needs an interactive visual map of where catch suggestions are located, as guided by ADR 018 "Smart Route Radar Architecture".
