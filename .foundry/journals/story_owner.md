...
* Action: Aborted task and submitted an empty PR to prevent session crash.
* Learning: Gen 3 roamer map coordinates are stored in EWRAM and are not serialized to the save file, making static extraction impossible as per ADR 108-027.
