...
- Carefully updated all references (YAML `depends_on` and inline markdown links) in active nodes (`epic-009-atomic-handoff-testing`, `epic-010-oxlint-config`, `story-010-017-fix-jest-rules`) to point to the new `./archive/` paths to prevent DAG orchestrator deadlocks.
