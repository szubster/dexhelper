...
## 2026-07-22: Consolidated QA and Testing Policies
...
- Created idea-121-diff-engine-hash-enforcement.md to address the recurring QA rejection pattern in the Box Diff Engine where developers faked hash logic.
