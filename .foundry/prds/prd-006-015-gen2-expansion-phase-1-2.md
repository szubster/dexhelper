...
- [x] **Epic Planner**: Break down this PRD into Epics for Phase 1 and Phase 2.
  ...
  - Epic 2: [.foundry/archive/.foundry/archive/epics/epic-015-027-exclusives-and-static-data.md](.foundry/archive/.foundry/archive/epics/epic-015-027-exclusives-and-static-data.md)
