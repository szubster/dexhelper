...
- If an active node contains an inline markdown link to a node that is being archived, the orchestrator MUST automatically update that link to point to the new `.foundry/archive/...` location.
