...
pr_number: null
parent: "./ideas/idea-011-researcher-persona
...
- [ ] Create a `researcher.md` journal policy/file in `./journals/`.
- [ ] Create a dedicated storage directory `./research/` for research output nodes.
- [x] Update the system schema (`./docs/schema.md`) to include the new persona and its responsibilities.
...
## Implementation
- ./epics/epic-011-021-researcher-persona.md
