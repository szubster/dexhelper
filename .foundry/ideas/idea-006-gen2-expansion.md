...
Convert the existing [Gen 2 Implementation Plan](.foundry/docs/shared_memory/development/gen2_implementation_plan.md) into a Foundry-orchestrated workflow. The strategy is broken down into four core phases:
