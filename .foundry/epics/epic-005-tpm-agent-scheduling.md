...
depends_on:
  - "./epics/epic-004-generic-agent-scheduling
jules_session_id: null
parent: "./prds/prd-001-agent-scheduling
tags: ["infrastructure"]
rejection_count: 1
notes: ""
---
...
The TPM agent must be configured to run on an hourly schedule. It should be capable of scanning the `` monofolder for `COMPLETED` nodes.
...
### Generated Stories
- ./stories/story-005-012-configure-tpm-schedule.md
- ./stories/story-005-013-tpm-archiving-logic.md
