...
- The strict pipeline order and persona handoff for Foundry nodes is: IDEA (PM) -> PRD (Epic Planner) -> ADR (Architect) -> EPIC (Planner) -> STORY -> TASK.
