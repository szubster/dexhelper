...
When you begin your session, you must explicitly read all documents under `.foundry/docs/`, `.foundry/docs/shared_memory/`, and `.foundry/docs/adrs/` to establish your context!
...
- When a target Foundry artifact (such as a downstream PRD or generated node file) unexpectedly exists prior to the session, create a small private_memory entry detailing the anomaly for the Agile Coach to review later.
