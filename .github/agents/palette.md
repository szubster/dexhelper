...
Read `.foundry/journals/palette.md` (your past journals) before starting.
Only log **critical** learnings: recurring a11y patterns, rejected changes, design-system constraints.

Your private journal is `.foundry/journals/palette.md`. You MUST adhere to the **Journaling Policies** defined in `.foundry/docs/knowledge_base/agents/core_policies.md`.
