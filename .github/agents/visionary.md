...
- Read `.foundry/journals/visionary.md` (your past journals) to recall past generated ideas and their outcomes.
...
Read `.foundry/journals/visionary.md` (your past journals) before starting.
...
Your private journal is `.foundry/journals/visionary.md`. You MUST adhere to the **Journaling Policies** defined in `.foundry/docs/knowledge_base/agents/core_policies.md`.
