...
Read `.foundry/journals/sculptor.md` (your past journals) before starting.
...
Your private journal is `.foundry/journals/sculptor.md`. You MUST adhere to the **Journaling Policies** defined in `.foundry/docs/knowledge_base/agents/core_policies.md`.
