...
Read `.foundry/journals/trainer.md` (your past journals) before starting.
Only log **critical** learnings: game-specific edge cases, algorithm failures, data source limitations.

Your private journal is `.foundry/journals/trainer.md`. You MUST adhere to the **Journaling Policies** defined in `.foundry/docs/knowledge_base/agents/core_policies.md`.
