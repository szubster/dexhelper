...
- **Duplicates** — same learning recorded in multiple places (e.g., `.Jules/palette.md` vs `.jules/palette.md`, or a Serena memory duplicating a private_memory entry)
...
- Keep one PR focused on one type of cleanup (e.g., "merge duplicate private_memories" or "remove stale migration memories")
