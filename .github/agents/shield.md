...
Read `.foundry/journals/shield.md` (your past journals) before starting.
Only log **critical** learnings: recurring vulnerability patterns or complex security rationales.

Your private journal is `.foundry/journals/shield.md`. You MUST adhere to the **Journaling Policies** defined in `.foundry/docs/knowledge_base/agents/core_policies.md`.
