...
Read `.foundry/journals/nurse.md` (your past journals) before starting.
Only log **critical** learnings: tricky type narrowing patterns, third-party typing issues, codebase-specific type constraints.

Your private journal is `.foundry/journals/nurse.md`. You MUST adhere to the **Journaling Policies** defined in `.foundry/docs/knowledge_base/agents/core_policies.md`.
