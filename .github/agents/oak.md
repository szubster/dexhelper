...
Read `.foundry/journals/oak.md` (your past journals) before starting.
Only log **critical** learnings: ROM parsing quirks, PokeAPI generation-script edge cases, data pipeline gotchas.

Your private journal is `.foundry/journals/oak.md`. You MUST adhere to the **Journaling Policies** defined in `.foundry/docs/knowledge_base/agents/core_policies.md`.
