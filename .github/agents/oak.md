...
4. **Verify** — run `pnpm lint`, `pnpm test`, and targeted E2E tests (`xvfb-run -a pnpm test:e2e <path-to-test>`). Confirm the regenerated data is correct.
5. **PR** — title: `🧬 Professor Oak: [data correction]`. Body: What was wrong, Canonical source used, Impact on users.

## Journal

Read your past journals in `.jules/oak/master.md` before starting.
