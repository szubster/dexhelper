...
export const validNodeFrontmatter = fc.record({
  ...
  owner_persona: fc.constantFrom('palette', 'product_manager', 'epic_planner', 'story_owner', 'architect', 'tech_lead', 'coder', 'qa', 'human', 'tpm', 'agile_coach', 'mechanic', 'researcher', 'auditor', 'canvas', 'changelogger', 'lens'),
