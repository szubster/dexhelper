...
## 2026-06-25 - Removing dead code\n\n**Learning:** When using `knip` for dead code detection, always manually verify whether the flagged exports are implicitly used or totally obsolete. In the case of `AliveTeamView` and `VisitedRoutesChecklist`, removing the files directly cleaned up the bundle significantly.\n\n
