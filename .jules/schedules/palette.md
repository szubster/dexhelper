...
**Run e2e tests:** `npm test:e2e && npm test:ct` (runs playwright suite)
**Lint code:** `npm lint` (checks TypeScript and ESLint)
**Build:** `npm build` (production build - use to verify)
