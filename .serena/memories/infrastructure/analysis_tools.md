...
- **Codecov Bundle Analysis**: Replaced BundleMon in April 2026. Bundle size monitoring is handled automatically via `@codecov/vite-plugin` and tracked in Codecov alongside test coverage.
